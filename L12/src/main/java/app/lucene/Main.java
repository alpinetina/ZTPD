...
//        String querystr = "akcja AND NOT Lucyna";
//        String querystr = "near((naturalnie, morderca), 2, TRUE)";
//        String querystr = "near((naturalnie, morderca), 1, TRUE)";
//        String querystr = "near((naturalnie, morderca), 0, TRUE)";
